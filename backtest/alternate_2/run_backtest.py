...
from simple_improved_strategy import SimpleImprovedTrader
...
def run_backtest():
    ...
    temp_trader = SimpleImprovedTrader(None)
    ...
    trader = SimpleImprovedTrader(mock_fyers, max_trade_value=TRADE_VALUE)
    ...
    import json
    with open('backtest/alternate_2/backtest_metrics.json', 'w') as f:
        json.dump(output_data, f, indent=4)
    
    print("\n" + "="*30)
    print("SIMPLE IMPROVED STRATEGY")
    print("="*30)
    ...
    generate_html_report('backtest/alternate_2/backtest_metrics.json', 'backtest/alternate_2/report.html')
